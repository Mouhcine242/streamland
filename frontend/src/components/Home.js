...
const Home = () => {
  ...
  <a class="logo-expand" href="#">StreamingBoard</a>
  ...
  <div class="side-wrapper">
   ...
   <div class="side-menu">
    <Link to="/Streaming"><a class="sidebar-link" href="#">
     <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    <Link to = "/blogs"><a class="sidebar-link" href="#">
     <svg viewBox="0 0 24 24" fill="currentColor">
 ...
 <div class="wrapper">
  <div class="header">
   ...
   <div class="user-settings">
       <Link to = "/authentication"><button type="button" class="">logIn</button></Link>
  ...
  <div className="main-container">
    ...
    <h5>Recently released games</h5>
    <div className="main-blogs">
      
      { games && 
        games.map(games => (
         <a href='#'> <div class="card">
          <img src= {games?.gameimageurl} class="card-img-top" alt="..."/>
          <div class="card-body">
            <h5>{games?.gamename}</h5>
            <h6 class="card-text">{games?.gamedescription}</h6>
          </div>
        </div></a>
    ...
    <div class="small-header anim" ><h3>Live Channels</h3></div>
  </div>
    </div>
