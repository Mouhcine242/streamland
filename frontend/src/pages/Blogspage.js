...
const Blogspage = () => {
  ...
  <div class="side-wrapper">
   ...
   <div class="side-menu">
   <Link to="/"> <a class="sidebar-link discover is-active" href="">
 ...
 <div class="wrapper">
  <div class="header">
   ...
   <div class="user-settings">
       <Link to = "/authentication"><button type="button" class="">Add Blog</button></Link>
  ...
  <div className="blogs">
    ...
    {blogs && blogs.map(blogs => (
      ...
      <div className="blog" style={{scrollBehavior : 'smooth'}}>
        <Blog title={blogs.title} desc = {blogs.descriptionBlog} author={blogs.author} image={blogs.imageUrl} />
      </div>
    ))}
